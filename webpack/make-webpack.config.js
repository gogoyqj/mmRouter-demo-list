...
var alias = {
    ...
    route      : 'script/route',
    Animation  : 'script/animation/avalon.animation.js'
}
...
function makeConf(options){
    ...
    var config = {
        entry: {
            route : 'route',
            lib   : ['avalon', 'mmPromise', 'mmRequest', 'mmState', 'Animation']
        },
        output: {
            path: path.resolve('__build'),
            filename: 'build/script/[name].js',
            chunkFilename: 'build/script/[chunkhash:8].chunk.js',
            publicPath: '/'
        },
        ...
        plugins: [
            ...
            new webpack.optimize.CommonsChunkPlugin("lib", "build/script/lib.js")
        ],
        devServer: {
            stats: {
                cached: false,
